...
var Stream$4 = require$$1__default$2["default"];
...
function destroy$1 (stream, suppress) {
  ...
  if (isEventEmitter(stream) && suppress) {
    ...
    stream.addListener('error', noop$2);
  }
...
function destroyZlibStream (stream) {
  if (typeof stream.destroy === 'function') {
    ...
    } else if (stream._destroy && stream._destroy !== Stream$4.Transform.prototype._destroy) {
...
function hasDestroy (stream) {
  return stream instanceof Stream$4 &&
...
/* istanbul ignore next */
var defer$3 = typeof setImmediate === 'function'
  ? setImmediate
...
function onFinished$3 (msg, listener) {
  if (isFinished$1(msg) !== false) {
    defer$3(listener, null, msg);
    return msg
  }

  // attach the listener to the message
  attachListener(msg, wrap$2(listener));
...
function requireUtil_inspect () {
	...
	util_inspect = require$$1__default["default"].inspect;
	return util_inspect;
}
...
var debug$7 = src$1.exports('finalhandler');
...
var debug$6 = src$1.exports('express:router:layer');
...
var http$5 = require$$3__default$1["default"];
...
var debug$5 = src$1.exports('express:router:route');
...
var debug$4 = src$1.exports('express:router');
...
proto.handle = function handle(req, res, out) {
  ...
  debug$4('dispatching %s %s', req.method, req.url);
  ...
  function trim_prefix(layer, layerError, layerPath, path) {
    if (layerPath.length !== 0) {
      ...
      debug$4('trim prefix (%s) from url %s', layerPath, req.url);
      removed = layerPath;
    ...
    debug$4('%s %s : %s', layer.name, layerPath, req.originalUrl);
...
proto.use = function use(fn) {
  ...
  for (var i = 0; i < callbacks.length; i++) {
    ...
    // add the middleware
    debug$4('use %o %s', path, fn.name || '<anonymous>');
...
var debug$3 = src$1.exports('express:view');
var path$3 = require$$0__default["default"];
var fs$3 = require$$1__default$1["default"];
...
var Stats = require$$1__default$1["default"].Stats;
...
var debug$2 = src$1.exports('send');
...
var Stream$2 = require$$1__default$2["default"].Stream;
...
var Stream$1 = require$$1__default$2["default"].Stream;
...
var parseUrl$1 = require$$0__default$4["default"].parse;
var fs = require$$1__default$1["default"];
var Stream = require$$1__default$2["default"].Stream;
var mime = mimeTypes;
...
var parseUrl = require$$0__default$4["default"].parse;
...
var debug_1 = function () {
  if (!debug$1) {
    try {
      ...
      debug$1 = src$1.exports("follow-redirects");
    }
    catch (error) { /* */ }
...
var https$1 = require$$4__default$1["default"];
var Writable = require$$1__default$2["default"].Writable;
...
const express = express$2.exports;
const axios = axios_1;
...
async function remoteTranslate(text = "") {
    const url = "https://deep.haoda7.repl.co/translate";
